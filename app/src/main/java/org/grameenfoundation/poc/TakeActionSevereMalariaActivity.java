...
public class TakeActionSevereMalariaActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("severe_malaria")){
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > Severe Anaemia");
        ...
        setContentView(R.layout.activity_first_trimester_malaria);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > 1st Trimester");
        data="ANC Diagnostic: Malaria > 1st Trimester";
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > 2nd Trimester");
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > 3rd Trimester");
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > Test Negative");
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Malaria > Test not done");
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Anaemia > Severe Anaemia");
