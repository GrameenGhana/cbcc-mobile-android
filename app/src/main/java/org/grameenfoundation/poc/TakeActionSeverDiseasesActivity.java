...
public class TakeActionSeverDiseasesActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_difficulty_breathing);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Difficulty Breathing");
	    json=new JSONObject();
	    try {
        ...
        setContentView(R.layout.activity_cyanosis);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Cyanosis");
	    json=new JSONObject();
	    try {
        ...
        setContentView(R.layout.activity_convulsion);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Convulsion");
	    json=new JSONObject();
	    try {
        ...
        TextView click_here=(TextView) findViewById(R.id.textView_clickHere);
		   click_here.setOnClickListener(new OnClickListener(){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Fever");
    	    json=new JSONObject();
    	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Difficulty Feeding");
     	    json=new JSONObject();
     	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Umbilicus Red or Draining Pus, Skin Pustules");
     	    json=new JSONObject();
     	    try {
  		 ...
  		 click_here_too.setOnClickListener(new OnClickListener(){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Eye Infection");
     	    json=new JSONObject();
     	    try {
		   ...
		   click_here.setOnClickListener(new OnClickListener(){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > No Syptoms");
     	    json=new JSONObject();
     	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Hypothermia");
     	    json=new JSONObject();
     	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Low Temperature");
     	    json=new JSONObject();
     	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Very Severe Disease > Fast Breathing");
     	    json=new JSONObject();
     	    try {
