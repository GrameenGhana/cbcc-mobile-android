...
public class TakeActionFeedingProblemsActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("not_attached")){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Not Attached");
       	    json=new JSONObject();
       	    try {
     	   ...
     	   setContentView(R.layout.activity_poor_attachement);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Not Suckling");
     	    json=new JSONObject();
     	    try {
 		...
 		click_here_three.setOnClickListener(new OnClickListener(){
   	   ...
   	   setContentView(R.layout.activity_breastfeeding);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > BreastFeeding");
	    json=new JSONObject();
	    try {
	...
	click_here_three.setOnClickListener(new OnClickListener(){
		...
		public void onClick(View v) {
   	   ...
   	   setContentView(R.layout.activity_receive_other_foods);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Receive Other Foods");
   	   json=new JSONObject();
   	   try {
  	...
  	click_here_three.setOnClickListener(new OnClickListener(){
  		...
  		public void onClick(View v) {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Not Breastfeeding");
      	   json=new JSONObject();
      	   try {
     	...
     	click_here_too.setOnClickListener(new OnClickListener(){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Low Weight for age");
     	   json=new JSONObject();
     	   try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > Thrush");
    	   json=new JSONObject();
    	   try {
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Feeding Problems > No Feeding Problems");
     	   json=new JSONObject();
     	   try {
