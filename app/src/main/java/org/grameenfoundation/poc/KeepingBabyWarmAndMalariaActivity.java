...
public class KeepingBabyWarmAndMalariaActivity extends BaseActivity {
	...
	mContext= KeepingBabyWarmAndMalariaActivity.this;
        ...
        if(category.equals("keeping_baby_warm")){
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Keeping Baby Warm");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Malaria Prevention");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Psychosocial Support");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Rest & Activity");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Sexual Relations");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: TT Immunisation");
            ...
            getSupportActionBar().setSubtitle("PNC Counselling: Treating Bloody Diarrhoea");
