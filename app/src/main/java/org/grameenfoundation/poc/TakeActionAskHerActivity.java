...
//	Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("Excessive Vomiting")){
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Excessive Vomiting");
        	  json=new JSONObject();
      	    try {
    	      ...
    	      setContentView(R.layout.activity_danger_signs);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Offensive/ Discolored Vaginal Discharge");
        	  json=new JSONObject();
      	    try {
    	    	 ...
    	    	 setContentView(R.layout.activity_danger_signs);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Severe Abdominal Pain");
           	  json=new JSONObject();
         	    try {
    	    	...
    	    	setContentView(R.layout.activity_danger_signs);
	   	 getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Epigastric Pain");
          	  json=new JSONObject();
        	    try {
    	    	...
    	    	setContentView(R.layout.activity_danger_signs);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Edema of the feet, face or ankles");
             	  json=new JSONObject();
           	    try {
    	    	...
    	    	setContentView(R.layout.activity_danger_signs);
            	  textView_takeAction=(TextView) findViewById(R.id.textView_takeActionCategory);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > BP  ≥  90mm Hg");
             	  json=new JSONObject();
           	    try {
    	    	...
    	    	setContentView(R.layout.activity_danger_signs);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Severe headache/blurred vision");
             	  json=new JSONObject();
           	    try {
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Difficulty Breathing");
            	  json=new JSONObject();
          	    try {
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Shock");
           	  json=new JSONObject();
         	    try {
