...
public class TakeActionOtherSeriousConditionActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_bleeding_umbilical_cord);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Bleeding Umbilical Cord");
        ...
        setContentView(R.layout.activity_soft_swelling);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Soft Swelling");
	    json=new JSONObject();
	    try {
        ...
        setContentView(R.layout.activity_open_tissue);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Open Tissue");
	    json=new JSONObject();
	    try {
        ...
        TextView click_here=(TextView) findViewById(R.id.textView_clickHere);
		   click_here.setOnClickListener(new OnClickListener(){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > No Urine");
    	    json=new JSONObject();
    	    try {
            ...
            setContentView(R.layout.activity_no_urine);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Vomiting");
    	    json=new JSONObject();
    	    try {
            ...
            setContentView(R.layout.activity_no_urine);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Blood in Stool");
    	    json=new JSONObject();
    	    try {
