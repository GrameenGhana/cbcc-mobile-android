...
public class EncouragingPNCActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("care_of_newborns")){
            ...
            getSupportActionBar().setSubtitle("ANC Counselling: Care of Newborns");
            ...
            getSupportActionBar().setSubtitle("ANC Counselling: Postpartum Family Planning");
            ...
            getSupportActionBar().setSubtitle("ANC Counselling: When to return for PNC");
