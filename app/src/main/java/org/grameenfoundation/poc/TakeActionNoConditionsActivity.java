...
public class TakeActionNoConditionsActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_asymmetrical_limb);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Asymmetrical Limb");
	    json=new JSONObject();
	    try {
        ...
        setContentView(R.layout.activity_swelling_on_head);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Other Serious Conditions > Swelling on the head");
	    json=new JSONObject();
	    try {
