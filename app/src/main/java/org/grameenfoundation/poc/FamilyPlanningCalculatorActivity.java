...
public class FamilyPlanningCalculatorActivity extends ActionBarActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Family Planning Calculator");
	...
	public void calculateDueDate(){
		...
		if(spinner.getSelectedItem().toString().equals("One month interval")){
			...
			textView_injectionDate.setText(newDate.toString("dd-MMM-YYYY"));
		}else if(spinner.getSelectedItem().toString().equals("Three year interval")){
			DateTime newDate=new DateTime(selected_date).plusYears(3);
			textView_injectionDate.setText(newDate.toString("dd-MMM-YYYY"));
		}else if(spinner.getSelectedItem().toString().equals("Five year interval")){
			DateTime newDate=new DateTime(selected_date).plusYears(5);
			textView_injectionDate.setText(newDate.toString("dd-MMM-YYYY"));
		}else if(spinner.getSelectedItem().toString().equals("Ten year interval")){
			DateTime newDate=new DateTime(selected_date).plusYears(10);
			textView_injectionDate.setText(newDate.toString("dd-MMM-YYYY"));
		}
