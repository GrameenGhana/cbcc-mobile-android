...
public class TakeActionBleedingActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.activity_heavy_bleeding);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Heavy Bleeding ");
	    json=new JSONObject();
	    try {
        ...
        setContentView(R.layout.activity_light_bleeding);
            getSupportActionBar().setSubtitle("ANC Diagnostic: Managing Danger Signs > Light Bleeding ");
	    json=new JSONObject();
	    try {
