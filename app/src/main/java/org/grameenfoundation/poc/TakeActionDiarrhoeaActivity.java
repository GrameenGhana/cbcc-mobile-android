...
public class TakeActionDiarrhoeaActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("severe_diarrhoea")){
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Diarrhoea > Severe Diarrhoea");
            ...
            getSupportActionBar().setSubtitle("PNC Diagnostic: Diarrhoea > Blood in Stool");
   	   ...
   	   setContentView(R.layout.activity_no_diarrhoea);
            getSupportActionBar().setSubtitle("PNC Diagnostic: Diarrhoea > No Diarrhoea");
