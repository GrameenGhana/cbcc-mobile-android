...
public class ExclusiveBreastFeedingActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    json=new JSONObject();
	    try {
			json.put("page", "PNC Counselling: Exclusive Breastfeeding");
	...
	public void onBackPressed()
	{
		...
		//dbh.insertCCHLog("Point of Care", "PNC Counselling Exclusive Breastfeeding", start_time.toString(), end_time.toString());
