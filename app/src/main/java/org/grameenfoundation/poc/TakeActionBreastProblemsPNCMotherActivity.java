	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (extras != null) {
	        ...
	        if(take_action_category.equals("mastitis")){
                ...
                getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Breast Problems > Mastitis");
	       	    	json=new JSONObject();
	       	    	try {
                ...
                getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Breast Problems > Breast Engorgment");
	      	    json=new JSONObject();
	      	    try {
                ...
                getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Breast Problems > Cracked Nipples");
		      	    json=new JSONObject();
		      	    try {
                ...
                getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Breast Problems > No Problems");
		      	    json=new JSONObject();
		      	    try {
