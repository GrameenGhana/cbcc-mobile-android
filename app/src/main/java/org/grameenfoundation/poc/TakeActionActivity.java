	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  //  textView_takeAction=(TextView) findViewById(R.id.textView_takeActionCategory);
        ...
        if(take_action_category.equals("Difficulty breathing")){
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Acute Emergencies > Difficulty Breathing");
        	   json=new JSONObject();
       	    try {
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Acute Emergencies > Edema");
        	 json=new JSONObject();
     	    try {
            ...
            getSupportActionBar().setSubtitle("ANC Diagnostic: Acute Emergencies > Shock");
        	 json=new JSONObject();
     	    try {
