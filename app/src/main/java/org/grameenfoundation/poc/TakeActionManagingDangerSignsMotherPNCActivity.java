...
public class TakeActionManagingDangerSignsMotherPNCActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if(take_action_category.equals("difficulty_breathing")){
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Difficulty Breathing");
       	    json=new JSONObject();
       	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Shock");
       	    json=new JSONObject();
       	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Heavy Bleeding");
        	    json=new JSONObject();
        	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Convulsion");
      	    json=new JSONObject();
      	    try {
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Severe Headache");
        	    json=new JSONObject();
        	    try {
        	...
        	image.setImageResource(R.drawable.severe_headache);
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Diastolic BP ≥ 90 mmHg");
     	    json=new JSONObject();
     	    try {
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Severe abdominal pain");
      	    json=new JSONObject();
      	    try {
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Persistent vomiting");
       	    json=new JSONObject();
       	    try {
        	...
        	image.setVisibility(View.GONE);
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Pain in calf");
        	    json=new JSONObject();
        	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Painful or tender wound");
     	    json=new JSONObject();
     	    try {
        	...
        	image.setVisibility(View.GONE);
        	 ...
        	 setContentView(R.layout.activity_mng_danger_sign_gen_takeaction);
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Pain on urination");
      	    json=new JSONObject();
      	    try {
        	...
        	image.setVisibility(View.GONE);
        	 ...
        	 TextView text=(TextView) findViewById(R.id.textView_takeActionCategory);
        	 text.setText("Pallor");
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Pallor");
       	    json=new JSONObject();
       	    try {
            ...
            getSupportActionBar().setSubtitle("PNC Mother Diagnostic: Managing Danger Signs > Abnormal behaviour/depression");
        	    json=new JSONObject();
        	    try {
