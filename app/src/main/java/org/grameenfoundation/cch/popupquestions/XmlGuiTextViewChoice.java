...
public class XmlGuiTextViewChoice extends LinearLayout {
	...
	public XmlGuiTextViewChoice(final Context context,String labelText,final String link,String property) {
		super(context);
          ...
          ll.setDividerDrawable(getResources().getDrawable(R.drawable.divider));
