...
public class XmlGuiSubSection extends LinearLayout {
	TextView label;
	
	public XmlGuiSubSection(final Context context,String labelText,final String link,String property) {
		super(context);
          ...
          layoutParams.setMargins(50, 0, 0, 0);
		     ...
		     if(!link.equals("")&&!link.contains("ors_calculator")){
	...
	public XmlGuiSubSection(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
