...
public class XmlGuiTextViewBullet extends LinearLayout {
	TextView label;
	
	public XmlGuiTextViewBullet(Context context,String labelText,String options) {
		super(context);
	...
	public XmlGuiTextViewBullet(Context context, AttributeSet attrs) {
		super(context, attrs);
