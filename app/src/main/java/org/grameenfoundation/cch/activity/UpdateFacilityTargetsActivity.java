...
public class UpdateFacilityTargetsActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Update Facility Targets");
        ...
        ArrayAdapter<String> justification_adapter=new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,justifications);
